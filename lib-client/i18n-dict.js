...
export const DICT = {
  vi: {
    ...
    "land.footer": "© 2026 ELITVN. Phân tích dinh dưỡng thông minh.",
  ...
  en: {
    ...
    "land.footer": "© 2026 ELITVN. Smart nutrition analysis.",
    ...
    "guide.intro_title": "What is ELITVN?",
    "guide.intro_desc": "ELITVN is an AI nutrition assistant that helps users — especially those with underlying conditions — track and manage their daily diet to support recovery and treatment through nutrition.<br><br>Just enter your body metrics and goals, and the system automatically analyzes, calculates nutrition and suggests menus tailored to each health condition.",
    ...
    "hh.leave_desc_owner": "You're the family owner. To join someone else's family you must delete this one first (only possible once no other members remain).",
    ...
    "hh.confirm_delete_family": "Delete your family? All dependent members and the family's menus will be deleted with it. This cannot be undone.",
    ...
    "hh.join_desc": "Enter the 6-digit code the family owner shared with you.",
