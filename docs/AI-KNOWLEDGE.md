...
> ⚠️ **Tài liệu này đã LỖI THỜI.** Nó mô tả kiến trúc RAG dựa trên embedding
> (BGE-M3 / OpenAI / Lovable) trước khi refactor. Hệ thống hiện tại **không
> dùng embedding ở bất kỳ đâu** — retrieval chạy hoàn toàn bằng PostgreSQL
> Full Text Search (tsvector + GIN + ts_rank). Xem tài liệu hiện hành tại
> [`docs/KNOWLEDGE-BASE-FULLTEXT-SEARCH.md`](./KNOWLEDGE-BASE-FULLTEXT-SEARCH.md).
> Nội dung bên dưới được giữ lại chỉ để tham khảo lịch sử.
