...
> ⚠️ **Phần embedding trong tài liệu này đã LỖI THỜI.** Kho kiến thức hiện
> KHÔNG dùng embedding ở bất kỳ đâu — retrieval chạy bằng PostgreSQL Full
> Text Search (tsvector + GIN + ts_rank). Phần lưu/tải PDF qua Supabase
> Storage bên dưới vẫn đúng và không đổi. Xem kiến trúc hiện hành tại
