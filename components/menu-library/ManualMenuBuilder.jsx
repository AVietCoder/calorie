 ...
 *
 * ĐÃ THỬ VÀ BỎ: chế độ "nhập từng nguyên liệu" với ô riêng cho tên/lượng/đơn vị.
 * Ô input là controlled component mà giá trị được dựng lại từ chuỗi văn bản sau
 * mỗi phím gõ (parse → sửa → serialize), nên `.trim()` nuốt mất dấu cách đang gõ
 * và parser tự viết hoa lại chữ đầu — gõ "Cơm gà" ra "Cơmgà". Muốn làm lại thì
 * phải giữ state có cấu trúc thật, đừng parse ngược mỗi lần gõ.
 */
