...
const EXAMPLE_ROWS = [
  [1, 'breakfast', 'Phở gà', '35.000đ -> 45.000đ', 400, 450, 28, 12, 58, 2, 4, 920, 'gà', 'Bánh phở', 180, 'g', 'tinh bột'],
  [1, 'breakfast', 'Phở gà', '35.000đ -> 45.000đ', 400, 450, 28, 12, 58, 2, 4, 920, 'gà', 'Thịt gà', 100, 'g', 'đạm'],
  [1, 'breakfast', 'Phở gà', '35.000đ -> 45.000đ', 400, 450, 28, 12, 58, 2, 4, 920, 'gà', 'Hành lá', 10, 'g', 'gia vị'],
  [1, 'lunch', 'Cơm gạo lứt cá kho', '40.000đ -> 50.000đ', 500, 620, 34, 18, 72, 4, 5, 800, '', 'Gạo lứt', 120, 'g', 'tinh bột'],
  [1, 'lunch', 'Cơm gạo lứt cá kho', '40.000đ -> 50.000đ', 500, 620, 34, 18, 72, 4, 5, 800, '', 'Cá basa', 120, 'g', 'đạm'],
  [1, 'lunch', 'Canh bí đao nấu tôm', '15.000đ -> 18.000đ', 200, 90, 8, 2, 8, 2, 2, 400, '', 'Bí đao', 150, 'g', 'rau'],
  [1, 'dinner', 'Cơm + rau muống luộc + thịt kho', '35.000đ -> 45.000đ', 480, 560, 30, 16, 66, 5, 4, 850, '', 'Rau muống', 200, 'g', 'rau'],
  // Bỏ trống cũng được — hệ thống lưu chuỗi rỗng, không báo lỗi.
    ...
    blocks: [
      { type: 'title', text: 'MẪU NHẬP THỰC ĐƠN — DR.FIT' },
      {
        ...
        pairs: [
          ...
          ['Giá tiền', 'Cột price — gõ khoảng giá, giữ nguyên như bạn viết'],
  ...
  return {
    ...
    blocks: [
      { type: 'title', text: 'HƯỚNG DẪN ĐIỀN MẪU NHẬP THỰC ĐƠN' },
      {
        ...
        pairs: [
          ['Phiên bản mẫu', '2.1'],
          ['Mới ở 2.1', 'Thêm cột price (Giá tiền)'],
      ...
      { type: 'spacer' },
      {
        ...
        text:
          ...
          'Cột price (Giá tiền) được lưu Y NGUYÊN chuỗi bạn gõ — hệ thống không đổi sang số, không làm ' +
          'tròn, không đổi định dạng, và khi xuất file sẽ trả lại đúng chuỗi đó. Bạn có thể viết ' +
          '"15.000đ -> 18.000đ", "25k -> 30k" hay chỉ "40.000đ". Một món trải trên nhiều dòng nguyên ' +
          'liệu thì ghi cùng một giá ở mọi dòng (hệ thống lấy giá ở dòng đầu của món).',
      },
    ],
