...
const COLUMNS = [
  ...
  // Giá tiền là KHOẢNG GIÁ dạng chữ, giữ nguyên văn người nhập — xem chú thích
  // ở lib/excel/import/index.js (readPrice) và migrations/menu_dish_price.sql.
  { key: 'price', header: 'price', width: 16, desc: 'Giá tiền (một mức)', valid: 'Chữ, giữ nguyên như bạn gõ — vd: 14.000đ', required: false, example: '14.000đ' },
  { key: 'price_range', header: 'price_range', width: 26, desc: 'Khoảng giá', valid: 'Chữ — vd: 11.000đ–17.000đ/người', required: false, example: '11.000đ–17.000đ/người' },
  ...
  { key: 'ingredient_price', header: 'ingredient_price', width: 22, desc: 'Giá nguyên liệu', valid: 'Chữ, giữ nguyên như bạn gõ — vd: 12.000đ hoặc 12.000đ -> 15.000đ', required: false, example: '12.000đ' },
...
// Cùng một món lặp lại trên nhiều dòng nguyên liệu thì phải ghi CÙNG một giá —
// parser lấy giá ở dòng đầu tiên của món.
const EXAMPLE_ROWS = [
  [1, 'breakfast', 'Phở gà', '40.000đ', '35.000đ–45.000đ/người', 400, 450, 28, 12, 58, 2, 4, 920, 'gà', 'Bánh phở', 180, 'g', '12.000đ', 'tinh bột'],
  [1, 'breakfast', 'Phở gà', '40.000đ', '35.000đ–45.000đ/người', 400, 450, 28, 12, 58, 2, 4, 920, 'gà', 'Thịt gà', 100, 'g', '22.000đ', 'đạm'],
  [1, 'breakfast', 'Phở gà', '40.000đ', '35.000đ–45.000đ/người', 400, 450, 28, 12, 58, 2, 4, 920, 'gà', 'Hành lá', 10, 'g', '', 'gia vị'],
  [1, 'lunch', 'Cơm gạo lứt cá kho', '45.000đ', '40.000đ–50.000đ/người', 500, 620, 34, 18, 72, 4, 5, 800, '', 'Gạo lứt', 120, 'g', '8.000đ', 'tinh bột'],
  [1, 'lunch', 'Cơm gạo lứt cá kho', '45.000đ', '40.000đ–50.000đ/người', 500, 620, 34, 18, 72, 4, 5, 800, '', 'Cá basa', 120, 'g', '32.000đ', 'đạm'],
  [1, 'lunch', 'Canh bí đao nấu tôm', '16.000đ', '15.000đ–18.000đ/người', 200, 90, 8, 2, 8, 2, 2, 400, '', 'Bí đao', 150, 'g', '', 'rau'],
  [1, 'dinner', 'Cơm + rau muống luộc + thịt kho', '40.000đ', '35.000đ–45.000đ/người', 480, 560, 30, 16, 66, 5, 4, 850, '', 'Rau muống', 200, 'g', '10.000đ', 'rau'],
  // Bỏ trống mọi cột giá cũng được — hệ thống lưu chuỗi rỗng, không báo lỗi.
...
export function importTemplateSheet() {
  ...
  return {
    ...
    blocks: [
      { type: 'title', text: 'MẪU NHẬP THỰC ĐƠN — DR.FIT' },
      {
        type: 'meta',
        pairs: [
          ...
          ['Giá tiền', 'price (một mức) · price_range (khoảng) · ingredient_price — giữ nguyên như bạn viết'],
  ...
  return {
    ...
    blocks: [
      { type: 'title', text: 'HƯỚNG DẪN ĐIỀN MẪU NHẬP THỰC ĐƠN' },
      {
        ...
        pairs: [
          ['Phiên bản mẫu', '2.2'],
          ['Mới ở 2.2', 'Thêm price, price_range và ingredient_price — khớp bộ thực đơn chuẩn'],
      ...
      { type: 'spacer' },
      {
        ...
        text:
          ...
          'Ba cột giá — price (một mức, vd "14.000đ"), price_range (khoảng, vd "11.000đ–17.000đ/người") ' +
          'và ingredient_price (giá từng nguyên liệu) — đều được lưu Y NGUYÊN chuỗi bạn gõ: không đổi ' +
          'sang số, không làm tròn, không đổi định dạng, và khi xuất file sẽ trả lại đúng chuỗi đó. ' +
          'Cả ba đều tuỳ chọn, bỏ trống không sao.\n' +
          'Một món trải trên nhiều dòng nguyên liệu thì ghi cùng price và price_range ở mọi dòng (hệ ' +
          'thống lấy ở dòng đầu của món), còn ingredient_price ghi riêng cho từng dòng nguyên liệu.\n' +
          'Lưu ý: ingredient_price chỉ để HIỂN THỊ đối chiếu. Cột "Thành tiền" trong danh sách đi chợ ' +
          'vẫn tính theo bảng giá của hệ thống, vì bảng đó biết giá tính trên đơn vị nào (kg, bó, quả) ' +
          'còn ô Excel thì không — nhân bừa sẽ ra hoá đơn sai hàng chục lần.',
      },
    ],
