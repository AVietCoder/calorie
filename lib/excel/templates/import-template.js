...
const COLUMNS = [
  ...
  { key: 'price', header: 'price', width: 22, desc: 'Giá tiền (khoảng giá)', valid: 'Chữ, giữ nguyên như bạn gõ — vd: 15.000đ -> 18.000đ', required: false, example: '15.000đ -> 18.000đ' },
...
const EXAMPLE_ROWS = [
  [1, 'breakfast', 'Phở gà', '35.000đ -> 45.000đ', 400, 450, 28, 12, 58, 2, 4, 920, 'gà', 'Bánh phở', 180, 'g', '12.000đ', 'tinh bột'],
  [1, 'breakfast', 'Phở gà', '35.000đ -> 45.000đ', 400, 450, 28, 12, 58, 2, 4, 920, 'gà', 'Thịt gà', 100, 'g', '20.000đ -> 25.000đ', 'đạm'],
  [1, 'breakfast', 'Phở gà', '35.000đ -> 45.000đ', 400, 450, 28, 12, 58, 2, 4, 920, 'gà', 'Hành lá', 10, 'g', '', 'gia vị'],
  [1, 'lunch', 'Cơm gạo lứt cá kho', '40.000đ -> 50.000đ', 500, 620, 34, 18, 72, 4, 5, 800, '', 'Gạo lứt', 120, 'g', '8.000đ', 'tinh bột'],
  [1, 'lunch', 'Cơm gạo lứt cá kho', '40.000đ -> 50.000đ', 500, 620, 34, 18, 72, 4, 5, 800, '', 'Cá basa', 120, 'g', '30.000đ -> 35.000đ', 'đạm'],
  [1, 'lunch', 'Canh bí đao nấu tôm', '15.000đ -> 18.000đ', 200, 90, 8, 2, 8, 2, 2, 400, '', 'Bí đao', 150, 'g', '', 'rau'],
  [1, 'dinner', 'Cơm + rau muống luộc + thịt kho', '35.000đ -> 45.000đ', 480, 560, 30, 16, 66, 5, 4, 850, '', 'Rau muống', 200, 'g', '10.000đ', 'rau'],
  // Bỏ trống cả hai cột giá cũng được — hệ thống lưu chuỗi rỗng, không báo lỗi.
    ...
    blocks: [
      { type: 'title', text: 'MẪU NHẬP THỰC ĐƠN — DR.FIT' },
      {
        ...
        pairs: [
          ...
          ['Giá tiền', 'price (giá món) + ingredient_price (giá nguyên liệu) — giữ nguyên như bạn viết'],
  ...
  return {
    ...
    blocks: [
      { type: 'title', text: 'HƯỚNG DẪN ĐIỀN MẪU NHẬP THỰC ĐƠN' },
      {
        ...
        pairs: [
          ['Phiên bản mẫu', '2.1'],
          ['Mới ở 2.1', 'Thêm price (giá món) và ingredient_price (giá nguyên liệu)'],
      ...
      { type: 'spacer' },
      {
        ...
        text:
          ...
          'Hai cột giá (price cho món, ingredient_price cho nguyên liệu) được lưu Y NGUYÊN chuỗi bạn gõ ' +
          '— hệ thống không đổi sang số, không làm tròn, không đổi định dạng, và khi xuất file sẽ trả ' +
          'lại đúng chuỗi đó. Bạn có thể viết "15.000đ -> 18.000đ", "25k -> 30k" hay chỉ "40.000đ". ' +
          'Cả hai đều tuỳ chọn, bỏ trống không sao.\n' +
          'Một món trải trên nhiều dòng nguyên liệu thì ghi cùng một giá MÓN ở mọi dòng (hệ thống lấy ' +
          'giá món ở dòng đầu), còn ingredient_price thì ghi riêng cho từng dòng nguyên liệu.\n' +
          'Khi bạn khai ingredient_price, danh sách đi chợ sẽ hiển thị giá đó thay cho giá tra bảng tự ' +
          'động. Nếu bạn ghi một số cụ thể ("12.000đ") hệ thống tính được cột Thành tiền; nếu ghi một ' +
          'khoảng ("12.000đ -> 15.000đ") thì chỉ hiện khoảng giá, không tự chọn một con số để nhân.',
      },
    ],
