...
export async function listPdfs() {
  try {
    const { data, error } = await supabaseAdmin
      .from(PDFS)
      .select("id, file_name, file_size, cloudinary_url, cloudinary_public_id, storage_path, storage_bucket, status, error_message, chunk_count, embedding_count, uploaded_by_email, created_at")
