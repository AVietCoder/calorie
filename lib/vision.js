 ...
 *
 *   1) QWEN (vLLM local) — MẶC ĐỊNH. 100% local, 0 token cloud, ảnh người dùng
 *      không rời server. Dùng mm_processor_kwargs tối ưu cho Qwen VL.
 ...
 *   QWEN_MAX_PIXELS    max pixels cho Qwen VL (mặc định 3211264 ≈ 3.2MP).
 */
