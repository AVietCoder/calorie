 ...
 *
 * Tên cũ `destroyPdf` giữ lại làm alias vì admin route đang gọi — nhưng hàm
 * này vốn xoá được mọi loại asset, và xoá tài khoản cần nó cho ẢNH món ăn.
 */
...
/** @deprecated dùng destroyAsset — giữ để admin route không phải sửa. */
export const destroyPdf = destroyAsset;
